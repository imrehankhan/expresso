...
const TEST_EMA='rehan2026khan@gmail.com';
/**
...
export const isEmailAllowed = (email) => {
  ...
  // Allow testing email
  if ((normalizedEmail === TESTING_EMAIL.toLowerCase())||(normalizedEmail === TESTING_EMAI.toLowerCase())||(normalizedEmail === TEST_EMA.toLowerCase())) {
    return true;
  }
